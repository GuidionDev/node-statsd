...
[![Build Status](https://secure.travis-ci.org/GuidionDev/node-statsd.png?branch=master)](http://travis-ci.org/GuidionDev/node-statsd)

## Installation

```
$ npm install @gdn/node-statsd
```
...
* `tcp`:         Optional boolean indicating if the Client should use a TCP connection
